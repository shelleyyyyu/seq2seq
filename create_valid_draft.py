...
from utils import build_dict, build_valid_draft_dataset, test_batch_iter
import os
...
title_list, test_x = build_valid_draft_dataset(word_dict, article_max_len)
...
with tf.Session() as sess:
    ...
    if not os.path.exists("result"):
            os.mkdir("result")
    with open("result/valid.txt", "wr") as f:
        for story in story_test_result_list:
            f.write(story+"\n")
    print('Summaries are saved to "valid.txt"...')
